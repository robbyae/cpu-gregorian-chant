...
**Music Generation**
(c4)(e)(d)(ge)(d)(ghe)(g)(efe)(g)(hGF)(e)(fED)(e)(d)(ee)(d)(gh)(i)(h)(g.)(::)(h)(gd)(e)(dh)(j)(k)(i)(h)(i)(g)(hj)(i)(g)(e.)(::)
E3 D3 G3 E3 D3 G3 A3 E3 G3 E3 F3 E3 G3 A3 G3 F3 E3 F3 E3 D3 E3 D3 E3 E3 D3 G3 A3 B3 A3 G3. | A3 G3 D3 E3 D3 A3 C4 D4 B3 A3 B3 G3 A3 C4 B3 G3 E3. |
<br>
The music generates in [gabc](https://gregorio-project.github.io/gabc/) notation, a notation that uses ASCII characters to create Gregorian chant scores. In other words, the music generates in the form of "sheet music" (the audio is generated separately but based off of the score).



I believe it is important to note that the music is not generated by "AI". It is generated through an algorithm written in Python. The backbone of this algorithm is a [Markov chain](https://en.wikipedia.org/wiki/Markov_chain). Using Markov chains to generate Gregorian chant involves creating datasets of notes from real Gregorian songs (one for each mode) entered in order of their appearance. Below is the dataset for the first mode, called the Dorian mode.
