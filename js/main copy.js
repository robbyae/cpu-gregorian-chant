...
function loaded()
{
    ...
    document.getElementById("loading").style.display = "none";
    txt = 'Welcome to CPU Gregorian Chant! Gregorian Chant refers to the primary repertory of Western plainsong, a type of monophonic song sung in liturgies of the Western Church. Click our illuminated words for more information or select a mode and form to compose a chant.';
    find_important();
}
